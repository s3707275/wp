...
function end_module() {
    ...
    <footer>
        ...
        <button><a href="services.txt" target="_blank">Link to 'services.txt' Spreadsheet</a></button><br>
        <button><a href="orders.txt" target="_blank">Link to 'orders.txt' Spreadsheet</a></button>
        </footer>
    </div>
    </body>
